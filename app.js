...
function createQueueCard(caseData) {
  ...
  const severity = diagnosis.includes('Severe') || diagnosis.includes('SEVERE') ? 'SEVERE' : 
                   diagnosis.includes('Moderate') ? 'Moderate' : 
                   diagnosis.includes('AHEERE') ? 'AHEERE' : 'Mild';
  ...
  card.innerHTML = `
    <div class="case-info">
      <div class="case-text">
        ...
        <div class="case-main">CASE #${caseData.case_id} | ${severity === 'AHEERE' ? 'AHEERE' : 'AI-Flag: ' + severity}</div>
